...
<br>
<br><i>Gridwatch</i> - This site collates data reported every 5 mins for the UK.
...
<br><br>
These wind farms have been selected as they have roughly the same quoted capacity and cost in the same ballpark as the lagoon. Offshore wind was considered the best source to compare with the lagoon. Although the time period was selected arbitrarily, the Capacity Factor (proportion of maximum installed output actually generated) for each wind farm is in the 30-40% region, showing this time period is representative of average conditions. 
<br><br>
...
govtP = Div(text=para3, width=600, height=220)
govtPb = Div(text=para3b, width=600, height=300)
tidalvwindP = Div(text=para4, width=600, height=330)
LFP = Div(text=para5, width=500, height=300)
#show(p)